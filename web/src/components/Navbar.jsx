...
const Navbar = () => {
  return (
    <header>
        <nav className='flex px-20 justify-between py-5 bg-gradient-to-b from-gray-300  to-transparent'>
            <div className='flex flex-col -space-y-3'>
                <h1 className='font-grifter text-[32px]'>Segment Nothing</h1>
                <span className='font-inter text-[16px] text-slate-600'>Research by Su team</span>
            </div>
