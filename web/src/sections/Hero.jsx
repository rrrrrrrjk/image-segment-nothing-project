...
const Hero = () => {
  return (
    <section id="home" className='w-full min-h-screen flex xl:justify-between flex-col justify-center items-center xl:flex-row px-20 text-white py-[60px] xl:py-0 gap-y-20'>
      <div className='flex flex-col justify-center xl:items-start xl:w-2/5 gap-5 w-full text-center xl:text-start'>
